export const translations = {
  en: {
    ...
    rotationSaved: "Saved",
    rotation_smart: "Smart (Recommended)",
    rotation_smart_desc: "Weighted scoring across all dimensions.",
    rotation_round_robin: "Round Robin",
    rotation_round_robin_desc: "Cycle through accounts in stable ID order.",
    rotation_by_sessions: "By Active Sessions",
    rotation_by_sessions_desc: "Prefer accounts with fewer active conversations.",
    rotation_by_exhausted: "By Quota Exhaustion",
    rotation_by_exhausted_desc: "Avoid quota-exhausted accounts.",
    rotation_by_used_percent: "By Used Percent",
    rotation_by_used_percent_desc: "Prefer accounts with lower quota usage.",
    rotation_by_reset_time: "By Reset Time",
    rotation_by_reset_time_desc: "Prefer accounts whose quota resets soonest.",
    rotation_by_window_requests: "By Window Requests",
    rotation_by_window_requests_desc: "Prefer accounts with fewer requests in current window.",
    rotation_by_request_count: "By Total Requests",
    rotation_by_request_count_desc: "Prefer accounts with fewer cumulative requests.",
    rotation_by_lru: "By LRU",
    rotation_by_lru_desc: "Prefer the least recently used account.",
    rotationSmartWeights: "Smart Strategy Weights",
    rotationResetWeights: "Reset to defaults",
    rotation_weight_sessions: "Active Sessions",
    rotation_weight_exhausted: "Quota Exhaustion",
    rotation_weight_used_percent: "Used Percent",
    rotation_weight_reset_time: "Reset Time",
    rotation_weight_window_requests: "Window Requests",
    rotation_weight_request_count: "Total Requests",
    rotation_weight_lru: "LRU",
    ...
    errorsTab: "Errors",
    edge403Tab: "Edge 403",
    edge403Desc: "Structured records of upstream HTML 403 blocks by network exit. Raw HTML is not stored.",
    edge403TotalEvents: "Total Events",
    edge403BlockedIps: "Blocked Exits",
    edge403Latest: "Latest",
    edge403EgressIp: "Egress IP",
    edge403Count: "Count",
    edge403Account: "Account",
    edge403Proxy: "Proxy",
    edge403Endpoint: "Endpoint",
    edge403RayId: "Ray ID",
    edge403UnknownIp: "unknown IP",
    edge403Empty: "No Edge HTML 403 events recorded.",
  ...
  zh: {
    ...
    rotationSaved: "\u5df2\u4fdd\u5b58",
    rotation_smart: "智能分配（推荐）",
    rotation_smart_desc: "综合加权评分，自动平衡所有维度。",
    rotation_round_robin: "轮询",
    rotation_round_robin_desc: "按固定顺序轮流使用各账号。",
    rotation_by_sessions: "按活跃会话数",
    rotation_by_sessions_desc: "优先选择活跃对话最少的账号。",
    rotation_by_exhausted: "按配额耗尽",
    rotation_by_exhausted_desc: "避免已耗尽配额的账号。",
    rotation_by_used_percent: "按使用百分比",
    rotation_by_used_percent_desc: "优先选择配额用量最低的账号。",
    rotation_by_reset_time: "按重置时间",
    rotation_by_reset_time_desc: "优先选择即将重置配额的账号。",
    rotation_by_window_requests: "按窗口请求数",
    rotation_by_window_requests_desc: "优先选择当前窗口内请求最少的账号。",
    rotation_by_request_count: "按累积请求数",
    rotation_by_request_count_desc: "优先选择总请求数最少的账号。",
    rotation_by_lru: "按最近使用",
    rotation_by_lru_desc: "优先选择最久未使用的账号。",
    rotationSmartWeights: "智能策略权重配置",
    rotationResetWeights: "恢复默认",
    rotation_weight_sessions: "活跃会话数",
    rotation_weight_exhausted: "配额耗尽",
    rotation_weight_used_percent: "使用百分比",
    rotation_weight_reset_time: "重置时间",
    rotation_weight_window_requests: "窗口请求数",
    rotation_weight_request_count: "累积请求数",
    rotation_weight_lru: "最近使用",
    ...
    errorsTab: "错误",
    edge403Tab: "Edge 403",
    edge403Desc: "按网络出口记录上游 HTML 403 拦截。不会保存原始 HTML。",
    edge403TotalEvents: "事件总数",
    edge403BlockedIps: "被拒出口",
    edge403Latest: "最近一次",
    edge403EgressIp: "出口 IP",
    edge403Count: "次数",
    edge403Account: "账号",
    edge403Proxy: "代理",
    edge403Endpoint: "端点",
    edge403RayId: "Ray ID",
    edge403UnknownIp: "未知 IP",
    edge403Empty: "暂无 Edge HTML 403 事件。",
