...
# 默认使用 gpt-5.2-codex（codex 别名）
# 切换模型: export ANTHROPIC_MODEL=codex-fast / gpt-5.4 / gpt-5.1-codex-mini ...
claude
```

> 也可以在控制面板的 **Anthropic SDK Setup** 卡片中一键复制环境变量。

### Cursor

Settings → Models → OpenAI API Base: `http://localhost:8080/v1`，API Key 从控制面板获取。
...
<details>
<summary>Python / Node.js 示例</summary>
